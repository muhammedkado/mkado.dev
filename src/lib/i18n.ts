...
const en = {
  ...
  contact: {
    ...
    form: {
      ...
      email: 'Your e-mail',
      message: 'Message',
      messageHint: 'What the role is, or what you would like built.',
      send: 'Send message',
      sending: 'Sending…',
      privacy: 'Your message and e-mail address are stored on my own server and used only to reply.',
      okTitle: 'Thank you, your message arrived.',
      okBody: (email: string) => `I read everything myself and reply to ${email}, usually within a day.`,
      retry: 'Try again',
      ...
      err: {
        ...
        rate: 'Too many messages from this connection today.',
        server: 'Something went wrong on my side.',
...
const trUi: typeof en = {
  ...
  contact: {
    ...
    form: {
      h3: 'Bana mesaj gönderin',
      name: 'Adınız',
      email: 'E-posta adresiniz',
      message: 'Mesaj',
      messageHint: 'Pozisyonun ne olduğunu ya da nasıl bir iş istediğinizi yazın.',
      send: 'Mesajı gönder',
      sending: 'Gönderiliyor…',
      privacy: 'Mesajınız ve e-posta adresiniz kendi sunucumda saklanır ve yalnızca size dönüş yapmak için kullanılır.',
      okTitle: 'Teşekkürler, mesajınız ulaştı.',
      okBody: (email: string) => `Hepsini kendim okuyorum ve genelde bir gün içinde ${email} adresine dönüyorum.`,
      retry: 'Tekrar dene',
      fallback: 'ya da doğrudan şu adrese yazın:',
      err: {
        required: 'Bu alan zorunlu.',
        nameShort: 'Lütfen en az 2 karakter girin.',
        emailInvalid: 'Lütfen geçerli bir e-posta adresi girin.',
        messageShort: 'Lütfen en az 20 karakter yazın.',
        messageLong: 'Lütfen 2000 karakteri aşmayın.',
        captcha: 'Güvenlik kontrolü geçilemedi. Lütfen tekrar deneyin.',
        rate: 'Bu bağlantıdan bugün çok fazla mesaj gönderildi.',
        server: 'Benim tarafımda bir şeyler ters gitti.',
  ...
  footer: {
    line: "Statik Astro sitesi, istemci framework'ü yok · Derleme:",
    nav: 'Site',
    about: 'Bu site hakkında',
    notes: 'Notlar',
    rss: 'RSS',
